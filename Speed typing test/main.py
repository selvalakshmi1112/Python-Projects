...
if __name__ == '__main__':
    prompt = "Life always gives a next chance.If you failed for the first time, try to complete it in the next chance.Always believe in yourself that you can do anything if you put your strength and hardwork."
